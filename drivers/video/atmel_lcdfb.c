			     ...
			     struct fb_info *info)
{
	...
	case 16:
		...
		var->red.msb_right = var->blue.msb_right = var->green.msb_right = 0;	// add by dongking at 2011-07-01,like as timll
		break;
	case 32:
...
static int atmel_lcdfb_set_par(struct fb_info *info)
{
	...
	//atmel_lcdfb_stop_nowait(sinfo);	// comment by dongking at 2011-07-01, like as timll
