...
static struct platform_device at91sam9g45_cf0_device = {
	.name		= "pata_at91",
	.id		= 0,
	.dev		= {
...
static struct platform_device at91sam9g45_cf1_device = {
	.name		= "at91_cf",
	.id		= 1,
	.dev		= {
...
static struct sam9_smc_config __initdata at91sam9g45_cf_timing = {
	.ncs_read_setup		= 4,
	.nrd_setup		= 4,
	.ncs_write_setup	= 4,
	.nwe_setup		= 4,
...
void __init at91_add_device_cf(struct at91_cf_data *data)
{
	...
	csa |= (cs == 4) ? AT91_MATRIX_EBI_CS4A_SMC_CF0 : AT91_MATRIX_EBI_CS5A_SMC_CF1;
	at91_sys_write(AT91_MATRIX_EBICSA, csa);

	/* configure static memory controller */
	if (cpu_is_at91sam9g45()) {
		sam9_smc_configure(cs, &at91sam9g45_cf_timing);
	}
	else {
		printk(KERN_INFO "AT91: CPU is not AT91SAM9G45.\n");
		return;
	}
	...
	at91_set_A_periph(AT91_PIN_PC12, 1);	/* A25/CFRNW */

	at91_set_A_periph(AT91_PIN_PC15, 1);	/* nWAIT */
	at91_set_A_periph(AT91_PIN_PC8, 1);	/* CFCE1 */
	at91_set_A_periph(AT91_PIN_PC9, 1);	/* CFCE2 */

	if (cs == 4) {
		at91_set_A_periph(AT91_PIN_PC10, 1);	/* NCS4/CFCS0 */

		cf0_data = *data;
		platform_device_register(&at91sam9g45_cf0_device);
	} else {
		at91_set_A_periph(AT91_PIN_PC11, 1);	/* NCS5/CFCS1 */

		cf1_data = *data;
		platform_device_register(&at91sam9g45_cf1_device);
	}
}
#else
void __init at91_add_device_cf(struct at91_cf_data *data) {}
...
void __init at91_add_device_mci(short mmc_id, struct mci_platform_data *data)
{
	...
	if (mmc_id == 0) {		/* MCI0 */
		...
		if (data->slot[0].bus_width >= 4) {	// modify by dongking at 2011-06-30,like as timll
...
static const unsigned spi0_standard_cs[4] = { AT91_PIN_PB3, AT91_PIN_PD24, AT91_PIN_PD25, AT91_PIN_PD27 };  //by zzq Aug.13,2013
...
void __init at91_add_device_spi(struct spi_board_info *devices, int nr_devices)
{
	...
	if (enable_spi0) {
		at91_set_A_periph(AT91_PIN_PB0, 1);	/* SPI0_MISO */
		at91_set_A_periph(AT91_PIN_PB1, 1);	/* SPI0_MOSI */
		at91_set_A_periph(AT91_PIN_PB2, 1);	/* SPI0_SPCK */

		at91_clock_associate("spi0_clk", &at91sam9g45_spi0_device.dev, "spi_clk");
		platform_device_register(&at91sam9g45_spi0_device);
	}
	if (enable_spi1) {
		at91_set_A_periph(AT91_PIN_PB14, 1);	/* SPI1_MISO */
...
#else
void __init at91_add_device_lcdc(struct atmel_lcdfb_info *data) {}
void __init ek_fb_set_platdata(int default_display){}	// add by dongking at 2011-06-30,like as timll
#endif
...
static inline void configure_usart0_pins(unsigned pins)
{
	...
	at91_set_multi_drive(AT91_PIN_PB18,1);
...
static inline void configure_usart1_pins(unsigned pins)
{
	...
	//if (pins & ATMEL_UART_RTS) {
		//at91_set_A_periph(AT91_PIN_PB14, 0);	/* RTS1 */   //By zzq Aug.13,2013
		at91_set_gpio_output(AT91_PIN_PB14,0);
...
static inline void configure_usart2_pins(unsigned pins)
{
	...
	//if (pins & ATMEL_UART_RTS) {
		//at91_set_B_periph(AT91_PIN_PB15, 0);	/* RTS2 */  //By zzq Aug.13,2013
		at91_set_gpio_output(AT91_PIN_PB15,0);
...
static inline void configure_usart3_pins(unsigned pins)
{
	...
	//if (pins & ATMEL_UART_RTS) {
		//at91_set_B_periph(AT91_PIN_PB16, 0);	/* RTS3 */
